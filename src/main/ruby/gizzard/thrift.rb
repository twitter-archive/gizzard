...
module Gizzard
  module Thrift
    ...
    class T::MockThriftService < T::ThriftService
      def initialize
        super("localhost", 99)
      end
      def _proxy(rv_struct, method_name, *args)
    ...
    class MockShardManager < T::MockThriftService
    end
    
    [ShardManager, MockShardManager].each do |klass|
